...
export function VideoCard({ video, onPlay, onFindSimilar, onShowDetails, isSelected, onToggleSelect }: VideoCardProps) {
  ...
  return (
    <Card className={`overflow-hidden group shadow-sm hover:shadow-lg transition-all duration-200 bg-background flex flex-col !py-0 !gap-0 ${isSelected ? "ring-2 ring-primary" : ""}`}>
