...
def query_metadata(query: str, tool_context: ToolContext) -> dict:
    ...
    Returns:
        dict with keys:
            ...
            (on error, when applicable) exception_type, exception_message,
                exception_details: surfaced exception fields for debugging.
    ...
    try:
        ...
        # Keep this branch in sync with ui/video-search/api/agent/tools.py.
